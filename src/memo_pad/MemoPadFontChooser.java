...
/**
 * The MemoPadFontChooser Class
 *
 * @author: MAbdurrahman
 * @date: 19 January 2017
 * @version: 1.0.0.
 */
public class MemoPadFontChooser extends JComponent {
    ...
    private static Font DEFAULT_FONT = new Font("Bookman Old Style", Font.PLAIN, 12);
    ...
    protected JDialog createDialog(Component parent) {
        ...
        //approveButton.setFont(DEFAULT_FONT);
        approveButton.setFont(new Font("Bookman Old Style", Font.BOLD, 12));
...
//        dialog.setLocation(500, 200);
    ...
    protected JPanel getPreviewPanel() {
        if (previewPanel == null) {
            Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ("Preview"));
